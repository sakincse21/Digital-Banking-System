...
const agentValidator = (ifAgentExists) => __awaiter(void 0, void 0, void 0, function* () {
    if (!ifAgentExists) {
        throw new errorHandler_1.default(http_status_1.default.BAD_REQUEST, "Agent does not exist.");
    }
    if (ifAgentExists.role !== user_interface_1.IRole.AGENT) {
        throw new errorHandler_1.default(http_status_1.default.BAD_REQUEST, "Request to an agent please.");
    }
    if ((ifAgentExists === null || ifAgentExists === void 0 ? void 0 : ifAgentExists.status) == user_interface_1.IStatus.BLOCKED ||
        ...
        throw new errorHandler_1.default(http_status_1.default.BAD_REQUEST, "Agent account is Blocked/Suspended.");
    }
});
...
const userValidator = (ifUserExists) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (ifUserExists.role !== user_interface_1.IRole.USER) {
        throw new errorHandler_1.default(http_status_1.default.BAD_REQUEST, "Request to an User please.");
    }
    if ((ifUserExists === null || ifUserExists === void 0 ? void 0 : ifUserExists.status) == user_interface_1.IStatus.BLOCKED ||
        ...
        throw new errorHandler_1.default(http_status_1.default.BAD_REQUEST, "User account is Blocked/Suspended.");
    }
});
